...
public class MealTestData {
    ...
    public static void assertMatch(List<MealTo> actual, List<MealTo> withExcess) {
        assertThat(actual).usingElementComparatorIgnoringFields("user").isEqualTo(withExcess);
    }
